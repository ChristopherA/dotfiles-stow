...
# ~/.install/macos-harden/macos-setup.d/6-time.sh
...
#!! TBD: How do we reverse this?
hash tmutil &> /dev/null && sudo tmutil disablelocal

#!! TBD: It is possible that any cached local Time Machine backups need to
